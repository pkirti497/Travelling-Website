...
<body>
    <div class="container-fluid">
        ...
        <div class="row a">
            <div class="col-sm-6">
                <!-- <h2 class="b">DASHBOARD</h2> -->
                <img src="img/c2.gif" alt="">
                </div>
                <div class="col-sm-6 a1">
                <h5 style="margin-top:30px;"><i class="fa fa-sign-out" aria-hidden="true" style="color:white;">
              <a href="index.php">Admin Logout</a></i></h5>
        ...
        <div class="row">
            <div class="col-sm-2 b">
               <h4 class="d"><a href="admin.php" style="text-decoration:none;"><i class="fa fa-tachometer" aria-hidden="true" style="color:white;">DASHBOARD</a></i></h4>
                <ul>
